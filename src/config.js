...
const config = {
  componentName: getEnvironmentVariable("npm_package_name", "learningpath-frontend"),
  environment,
  editorialFrontendDomain: getEnvironmentVariable("EDITORIAL_FRONTEND_DOMAIN", editorialFrontendDomain()),
  ...
  ndlaFrontendDomain: getEnvironmentVariable("FRONTEND_DOMAIN", ndlaFrontendDomain),
