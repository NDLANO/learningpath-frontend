...
test('containers/Masthead default', t => {
  ...
  t.jsxNotIncludes(output, <Link to='/minside' className='site-nav_link'>Mine læringsstier</Link>, 'my page link');
...
test('containers/Masthead logged in', t => {
  ...
  t.jsxIncludes(output, <Link to='/minside' className='site-nav_link'>Mine læringsstier</Link>, 'my page link');
