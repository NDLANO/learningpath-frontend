...
test("component/LearningPathDropdown remove", () => {
  ...
  const component = shallow(<LearningPathDropdown learningPath={learningPath} onSelect={onSelect} />, {
    context: { lang: "nb" },
  });

  component.find(".dropdown-menu_item").last().find("button").simulate("click", { preventDefault });
...
test("component/LearningPathDropdown de-publish", () => {
  ...
  component.find(".dropdown-menu_item").at(1).find("button").simulate("click", { preventDefault });
...
test("component/LearningPathDropdown unlist", () => {
  ...
  const component = shallow(<LearningPathDropdown learningPath={privateLearningPath} onSelect={onSelect} />, {
    context: { lang: "nb" },
  });
...
test("component/LearningPathDropdown make copy", () => {
  ...
  component.find(".dropdown-menu_item").first().find("button").simulate("click", { preventDefault });
