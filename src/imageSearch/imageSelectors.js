...
export const getSelectedImage = createSelector([getImageSearch], (imageSearch) => ({
...
export const getResults = createSelector([getImageSearch], (imageSearch) => imageSearch.images.results);

export const getLastPage = createSelector([getImageSearch, getPageSize], (imageSearch, pageSize) =>
