...
const validate = (values) => {
  ...
  } else if (values.duration && Number.isNaN(values.duration.replace(/,/g, ".")) && Number.isNaN(values.duration)) {
    ...
    <form className="learning-path-form" onSubmit={handleSubmit}>
      ...
      <div className="learning-path_bd">
        ...
        <div className="learning-path-duration">
          <label htmlFor="duration" className="label--medium-bold  label--medium">
        ...
        <div className="learningPath-contributors">
          <label htmlFor="license" className="label--medium-bold  label--medium">
