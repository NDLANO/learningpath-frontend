...
const LearningPathContainer = ({ match }) => (
  <Switch>
    ...
    <PrivateRoute path="/learningpaths/:pathId/first-step" component={LearningPath} />
    <PrivateRoute path={`${match.url}/new`} component={CreateLearningPath} />
    <PrivateRoute path={`${match.url}/:pathId/step/:stepId`} component={LearningPath} />
    <PrivateRoute path={`${match.url}/:pathId`} component={LearningPath} />
  </Switch>
);
