...
test("component/Oembed urlIsNDLA", () => {
  ...
  expect(urlIsNDLAUrl("http://www.api.ndla.no/nb/node/12345")).toBeTruthy();
  expect(urlIsNDLAUrl("http://ndla-frontend.api.ndla.no/nb/node/12345")).toBeTruthy();
  ...
  expect(urlIsNDLAUrl("http://ndla-frontend.test.api.ndla.no/nb/node/12345")).toBeTruthy();
