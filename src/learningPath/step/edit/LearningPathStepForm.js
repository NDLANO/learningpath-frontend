...
const LearningPathStepForm = (props) => {
  const { step, lang, oembedPreview, error, handleSubmit, submitting, learningPath, licenseOptions, valid } = props;
...
const mapStateToProps = (state, props) => ({
  ...
  initialValues: {
    ...
    url: {
      ...
      embedType: props.step.embedUrl ? defined(props.step.embedUrl.embedType, "oembed") : "",
    },
    type:
      props.learningPath.learningsteps && props.learningPath.learningsteps.length > 0
        ? props.step.type
        : "INTRODUCTION",
