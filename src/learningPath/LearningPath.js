...
export class LearningPath extends Component {
  ...
  render() {
    ...
    const changeStatusButton =
      showButtonsUrls.includes(match.path) && match.isExact ? <LearningPathToCButtons /> : null;
    ...
    const pinterestButton =
      showButtonsUrls.includes(match.path) && match.isExact ? (
        <PinterestLightboxButton learningPath={learningPath} toggleLightBox={this.togglePinterest} />
      ) : null;
          ...
          <main className="two-column_col">
            <Switch>
              ...
              <Route
                ...
                render={(props) => <LearningPathStep copyright={copyright} {...props} />}
              />
...
export default withRouter(connect(mapStateToProps, LearningPath.mapDispatchToProps)(withTracker(LearningPath)));
