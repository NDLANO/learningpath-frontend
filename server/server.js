...
app.use(helmet({
  ...
  contentSecurityPolicy: process.env.NODE_ENV !== 'development' ? {
    directives: {
      ...
      connectSrc: ["'self'", 'ws://*.hotjar.com wss://*.hotjar.com', 'https://*.hotjar.com', 'https://*.zendesk.com', 'https://*.zopim.com', 'https://*.ndla.no', 'https://logs-01.loggly.com', 'https://www.googleapis.com'],
      frameSrc: ['*'],
